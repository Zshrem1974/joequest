...
export const EXCLUDE_NAMES = [
  ...
  // In-store / bank counter "cafés" surfaced by the Austin search (city #15).
  // Not standalone cafés: Capital One's bank-branch café chain, Nordstrom's
  // in-store espresso counter, and the café inside the Coach retail store.
  "capital one café", "capital one cafe",
  "nordstrom ebar",
  "coach coffee shop",
];
...
export const BAD_TYPES = new Set([
  ...
  "gas_station",
  "convenience_store",
  // Malls and department stores leak into neighborhood text searches when a
  // café operates inside them (Austin's "The Domain" surfaced this way).
  "shopping_mall",
  "department_store",
]);
