...
export const CITIES = [
  ...
  },
  {
    ...
    bbox:   { south: 40.15, north: 40.25, west: -85.45, east: -85.33 },
    center: { lat: 40.1934, lng: -85.3864 },
    addressRegex: /\bmuncie,?\s*in\b/i,
    searchQuery: "coffee shops in Muncie, IN",
  ...
  },
  {
    ...
    bbox:   { south: 33.65, north: 33.89, west: -84.55, east: -84.29 },
    center: { lat: 33.749, lng: -84.388 },
    addressRegex: /\batlanta,?\s*ga\b/i,
    searchQueries: [
      "coffee shops in Midtown Atlanta GA",
      "coffee shops in Buckhead Atlanta GA",
      "coffee shops in Old Fourth Ward Atlanta GA",
      "coffee shops in West Midtown Atlanta GA",
      "coffee shops in Inman Park Atlanta GA",
      "coffee shops in Virginia-Highland Atlanta GA",
    ],
    timezone: "America/New_York",
    mustInclude: [],
  },
  {
    ...
    bbox:   { south: 32.03, north: 32.15, west: 34.74, east: 34.81 },
    center: { lat: 32.0853, lng: 34.7818 },
    addressRegex: /tel[\s-]*aviv/i,
    searchQueries: [
      "coffee shops in Rothschild Tel Aviv Israel",
      "coffee shops in Florentin Tel Aviv Israel",
      "coffee shops in Neve Tzedek Tel Aviv Israel",
      "coffee shops in Dizengoff Tel Aviv Israel",
      "coffee shops in Tel Aviv Port Tel Aviv Israel",
      "coffee shops in Jaffa Tel Aviv Israel",
    ],
  ...
  },
  {
    ...
    // Core Austin metro: Slaughter Ln up to Parmer/Domain, Westlake
    // across to the airport. Suburbs (Round Rock, Cedar Park, Pflugerville)
    // deliberately outside the bbox.
    bbox:   { south: 30.13, north: 30.45, west: -97.90, east: -97.60 },
    center: { lat: 30.2672, lng: -97.7431 },
    addressRegex: /\baustin,?\s*tx\b/i,
    // Six neighborhood queries (multi-query pattern, dedup by Place ID)
    // to break the 20-result single-query cap — same approach as Miami/NYC.
    searchQueries: [
      "coffee shops in downtown Austin TX",
      "coffee shops in East Austin TX",
      "coffee shops in South Congress Austin TX",
      "coffee shops in South Lamar Zilker Austin TX",
      "coffee shops in North Loop Hyde Park Austin TX",
      "coffee shops in The Domain North Austin TX",
    ],
    timezone: "America/Chicago",
    mustInclude: [],
  },
